...
/**
 * A `MenuSelect` class for any popup {@link Menu}.
 *
 * @extends Component
 */
class MenuSelect extends Component {
  ...
  /**
   * Create the `MenuSelects`s DOM element.
   *
   * @return {Element}
  ...
  /**
   * Handle a click on a `MenuSelect`.
  ...
  /**
   * Handle `mouseleave` for `MenuSelect`.
   *
   * @param {Event} event
  ...
  /**
   * Handle tab, escape, down arrow, and up arrow keys for `MenuSelect`. See
  ...
  /**
   * Handle a `keyup` event on a `MenuSelect`. The listener for this is added in
   * the constructor.
   *
   * @param {Event} event
   *        Key press event
  ...
  /**
   * Put the current `MenuSelect` into a pressed state.
   */
  pressButton() {
    if (this.enabled_) {
  ...
  /**
   * Take the current `MenuSelect` out of a pressed state.
   */
  unpressButton() {
    if (this.enabled_) {
      this.buttonPressed_ = false;
  ...
  /**
   * Disable the `MenuSelect`. Don't allow it to be clicked.
   */
  disable() {
    this.unpressButton();
  ...
  /**
   * Enable the `MenuSelect`. Allow it to be clicked.
   */
  enable() {
    this.enabled_ = true;
...
Component.registerComponent('MenuSelect', MenuSelect);
